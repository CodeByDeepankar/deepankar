      ...
      <div className="container mx-auto max-w-7xl h-full flex flex-row items-center justify-between gap-2 md:gap-12">
        ...
        <div className="flex flex-col w-[55%] md:w-1/2 z-10 relative">
          ...
          <FadeUp delay={0.3}>
            <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-3 md:gap-6">
              <Magnetic>
                <Link href="#work" className="flex items-center gap-2 bg-primary text-primary-foreground hover:bg-primary/90 px-5 py-3 md:px-8 md:py-4 rounded-full text-[10px] md:text-sm font-mono tracking-widest uppercase transition-colors">
        ...
        <div className="relative w-[45%] md:w-1/2 h-[50vh] sm:h-[60vh] md:h-[90vh] mt-0 flex justify-end items-end md:items-center">
          <FadeUp delay={0.2} className="w-full h-full relative flex items-end md:items-center justify-end">
            <div className="absolute right-0 bottom-0 md:-right-24 md:-top-16 md:bottom-0 left-0 scale-[1.15] md:scale-110 origin-bottom md:origin-center pointer-events-none">
               <ChromaticImage 
            ...
            <div className="absolute bottom-4 left-0 md:bottom-12 md:-left-12 z-20 flex flex-col gap-4 md:gap-8 opacity-0 md:opacity-100">
